  ...
  return (
    <>
      <div className="text-center bg-[#F1F4F9] py-10 md:py-20 px-5 md:px-8 lg:px-0 mt-16 md:mt-0">
        <h2 className="flex justify-center gap-2 md:gap-4 items-center font-normal text-[30px] md:text-[50px] text-[#191919]">
          Meet{" "}
          <Image
            src={Logo}
        ...
        <Image
          ...
          alt="Patient video-chatting with Emma about surgery options"
          width={900}
          height={500}
